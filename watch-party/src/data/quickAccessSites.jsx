/**
 * Quick Access Sites — config for the shortened list shown in the
 * BrowserPlayer when no URL is loaded.
 *
 * Each entry has:
 *  - name       : Display label
 *  - url        : Full URL the webview should navigate to
 *  - category   : Grouping tag (for future filtering / color coding)
 *  - icon       : React component returning an inline SVG (currentColor)
 *
 * The SVGs are designed to be simple, one-colour outlines that fit the
 * dark zinc theme.  Feel free to add / remove entries.
 */
